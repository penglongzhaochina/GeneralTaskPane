...
OSF.isRTLLocale = function OSF$isRTLLocale(locale) {
    if (!locale) {
        return false;
    }
    return OSF.SupportedRTLLocales[locale.toLowerCase()] || false;
};
var ScriptLoading;
...
OSF._OfficeAppFactory = (function OSF__OfficeAppFactory() {
    ...
    var initialize = function OSF__OfficeAppFactory$initialize() {
        ...
        if (_hostInfo.isO15) {
            ...
            var versionRegExp = new RegExp("^\\d\\d\[.\]\\d\\d$");
            if ((OSF.HostSpecificFileVersionMap[hostTypeLowerCase]) == null ||
                ...
                (!versionRegExp.test(_hostInfo.hostSpecificFileVersion))) {
