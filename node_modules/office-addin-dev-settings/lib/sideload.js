...
function sideloadAddIn(manifestPath, app, canPrompt = false, appType, document) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const appsInManifest = manifestPath.endsWith(".json")
                ? [office_addin_manifest_1.OfficeApp.Outlook]
                : (0, office_addin_manifest_1.getOfficeAppsForManifestHosts)(manifest.hosts);
